	...
	<div style="width: 100%; height: 100%;" align="center">
		<div id="content" class="content" align="left">
			<div class="west">
				...
				<div class="operationArea" style="width:100%;display:none" align="center">
					<table style="width:95%;text-align:center;">
						...
						<tr>
							...
							<td>倒车：<input id="isBackForward" name="isBackForward" type="checkbox"/><a onclick="clearError()" class="blue button">清除错误</a></td>
							<td>
								<table style="width:100%">
									<tr>
										<td></td>

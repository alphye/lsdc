package com.lishengzn.lsdc.communication.service;
...
public interface APIStatusMessageSenderService extends MessageSenderService {
     ...
     * 查询机器人的被阻挡状态
     */
    ResponseBlock queryBlockStatus();

...
public class APIStatusSenderServiceImpl extends AbstractCommunicateAdapter implements APIStatusMessageSenderService {

    private static final Logger LOG = LoggerFactory.getLogger(APIStatusSenderServiceImpl.class);
    ...
    @Override
    public ResponseBlock queryBlockStatus() {
        ...
        synchronized (syncObj){
            ...
            try {
                syncObj.wait();
                ResponseBlock responseBlock = JSONObject.parseObject((syncObj).getCarrayedMessage(),ResponseBlock.class);

	...
	function move(op){
		...
		var command={"commandType":"vehicleMove","message":{"vehicleIp":$("#vehicleIp").val(),"direct":op,"cellNum":$("#moveCells").val()}};
	...
	function moveToPoint(coor){
		...
		var command={"commandType":"sendToNode","message":{"vehicleIp":$("#vehicleIp").val(),"destCoor":{"position_x":coor.X,"position_y":coor.Y}}};

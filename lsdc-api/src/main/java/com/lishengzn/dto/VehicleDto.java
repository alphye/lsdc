...
public class VehicleDto implements Serializable {
    ...
    public VehicleDto(String vehicleIp, Coordinate position, Coordinate targetPosition, double velocity_x, double velocity_y, double velocity, double angularVelocity, double acceleration, double angle, int pathId, int naviState, String naviStateName, int confidenceDegree, int radarCollisionAvoidance, int malfunction, long mileage, int contactChargingPile, int relayOn, int hasPackage, int flipState, int jackingDistance, int beltRotationState, int operationState, String operationStateName, double batteryCapacity, double batteryResidues, int batteryState) {

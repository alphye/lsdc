...
import com.lishengzn.lsdc.kernel.navi.communication.service.NaviMessageSenderService;
...
public class NaviSenderServiceImpl extends AbstractCommunicateAdapter implements NaviMessageSenderService {

    private static final Logger LOG = LoggerFactory.getLogger(NaviSenderServiceImpl.class);

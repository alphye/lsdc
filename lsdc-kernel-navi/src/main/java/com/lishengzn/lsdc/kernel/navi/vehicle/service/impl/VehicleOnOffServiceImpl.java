package com.lishengzn.lsdc.kernel.navi.vehicle.service.impl;
...
import com.lishengzn.lsdc.kernel.navi.vehicle.ClientOfVehicleFactory;
...
//    @Autowired
    ...
    public void vehicleOnline(Vehicle vehicle){
        ...
        ClientOfVehicleFactory.createNaviClient(vehicle);
    }
    ...
    public void vehicleOffline(Vehicle vehicle) {
        LOG.debug("车辆下线：{}",vehicle.getVehicleIp());
